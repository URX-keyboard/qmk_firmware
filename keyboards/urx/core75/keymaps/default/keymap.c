...
void load_custom_rgb(void) {
    ...
    // Safety Check: If brightness is all 0, the LEDs will be off. Force defaults.
    ...
    switch (*command_id)
    {
        case id_custom_set_value:
        {
            if (value_id == 1) {
                ...
                // Manual Save Trigger from Button
                save_custom_rgb();
            } else if (value_id == 3) {
                 // Palette Selection
